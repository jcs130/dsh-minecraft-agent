 ...
 *   交付：耳语「mc_deliver 岳山 给20铁锭」→ NPC 引擎 inbox → /clear 收货 → 绿宝石/祝福/咒语情报（2026-08-18 起公屏喊交付只回教学）
 *   转交：耳语「mc_deliver 通宝 @Kirito 给16煤」→ 集市掌柜公证交割（双方 5 格内，clear→give，对价双方自理）
 *   柜台：掌柜·通宝的 Offers 聚合全村当日委托，真人/外来客户端右键即原版 GUI 交易——
 *   服务器与客户端解耦的通用接口，不学任何行话也能做买卖（2026-08-18 三通道交易架构）

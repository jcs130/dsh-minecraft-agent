  ...
  const refreshAudience = async () => {
    try {
      ...
      if (rendered) {
        ...
        lines.push(
          `\u3010\u89C2\u4F17\u5EFA\u8BAE\u3011${adv.shouldReply ? "\u53EF\u4EE5\u56DE\u5E94" : "\u5148\u4E0D\u56DE"}\uFF1A${adv.reason}${adv.pick ? `\uFF5C\u5148\u56DE\u300C${adv.pick.slice(0, 20)}\u300D` : ""}${adv.pointcast ? "\uFF08\u70B9\u64AD\uFF1A\u82E5\u60F3\u91C7\u7EB3\u9700\u8FC7\u76EE\u6807\u9632\u6296\uFF0C\u4E14\u4E0D\u5F97\u538B\u5012\u5B89\u5168\uFF09" : ""}\u3014${adv.source === "classifier" ? "\u5FEB\u51B3\u7B56" : "\u542F\u53D1\u5F0F"}\u3015`
        );

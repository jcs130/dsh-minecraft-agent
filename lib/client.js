...
function McPanelView({ rpc }) {
  ...
  (0, import_react.useEffect)(() => {
    ...
    const tick = async () => {
      try {
        const res = await fetch("/mc-panel/data/", { headers: { Accept: "application/json" } }).then(async (r) => ({ ok: r.ok, value: await r.json() })).catch(() => ({ ok: false, value: null }));
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "mcp", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "wrap", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "bottom", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "card", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { children: "\u4EBA\u7269\uFF08\u542B\u76AE\u80A4\uFF09" }),
          (p?.characters ?? []).length ? p.characters.map((c) => {
            ...
            return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "item", style: { display: "flex", gap: 10, alignItems: "center" }, children: [
              presets[cur]?.url ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", { src: presets[cur].url, alt: "", width: 40, height: 40, style: { imageRendering: "pixelated" } }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "chip", children: "\u65E0\u76AE\u80A4" }),
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("select", { value: cur, onChange: (e) => {
                void saveSkin(e.target.value);
              }, children: Object.keys(presets).map((k) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: k, children: presets[k]?.displayName ?? k }, k)) })
            ] }, c.id);
          }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "empty", children: "\u5C1A\u65E0\u4EBA\u7269\uFF08agents.json \u4E3A\u7A7A\uFF09" })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "card", children: [
